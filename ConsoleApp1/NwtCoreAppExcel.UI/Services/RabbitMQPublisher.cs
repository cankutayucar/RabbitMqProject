...
namespace NwtCoreAppExcel.UI.Services
{
    public class RabbitMQPublisher
    {
        ...
        public void Publish(CreateExcelMessage createExcelMessage)
        {
            ...
            channel.BasicPublish(exchange: RabbitMQClientService.ExchangeName, routingKey: RabbitMQClientService.RoutingName, basicProperties: properties, body: bodyByte);
        }
    }
}
