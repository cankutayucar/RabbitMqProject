...
namespace NetCoreApp.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(AppDbContext context, IWebHostEnvironment webHostEnvironment, RabbitMqPublisher rabbitMqPublisher)
        {
            _context = context;
